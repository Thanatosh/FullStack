...
const App = () => {
  ...
  const handleVote = () => {
    const newPoints = [...pointsCopy]
    newPoints[selected] += 1
    setPointsCopy(newPoints)
    setMaxVotesIndex(newPoints.reduce((maxIndex, value, index, array) => (value > array[maxIndex] ? index : maxIndex), 0)
    )
  }
  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>Has {pointsCopy[maxVotesIndex]} votes</p>  
      </div>
      <h2>Give Feedback</h2>
      <div>
